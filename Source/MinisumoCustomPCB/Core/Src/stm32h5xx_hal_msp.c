...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PB0     ------> ADC1_INP9
    */
        GPIO_InitStruct.Pin = V_BATT_SENSE_Pin | LINE_RIGHT_Pin |
                              LINE_LEFT_Pin | MOTOR_SENSE_R_Pin |
                              MOTOR_SENSE_L_Pin | CONFIG_ADC_Pin |
                              SHARP_C_ANALOG_Pin | SHARP_L_ANALOG_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
    ...
    PB0     ------> ADC1_INP9
    */
        HAL_GPIO_DeInit(GPIOA, V_BATT_SENSE_Pin | LINE_RIGHT_Pin |
                                   LINE_LEFT_Pin | MOTOR_SENSE_R_Pin |
                                   MOTOR_SENSE_L_Pin | CONFIG_ADC_Pin |
                                   SHARP_C_ANALOG_Pin | SHARP_L_ANALOG_Pin);
...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef* htim_pwm)
{
    if (htim_pwm->Instance == TIM1) {
        ...
        __HAL_LINKDMA(htim_pwm, hdma[TIM_DMA_ID_UPDATE],
