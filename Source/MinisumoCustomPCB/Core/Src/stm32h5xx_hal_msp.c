...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PB0     ------> ADC1_INP9
    */
    GPIO_InitStruct.Pin = V_BATT_SENSE_Pin|LINE_RIGHT_Pin|LINE_LEFT_Pin|MOTOR_SENSE_R_Pin
                          |MOTOR_SENSE_L_Pin|CONFIG_ADC_Pin|SHARP_C_ANALOG_Pin|SHARP_L_ANALOG_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = SHARP_R_ANALOG_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(SHARP_R_ANALOG_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PB0     ------> ADC1_INP9
    */
    HAL_GPIO_DeInit(GPIOA, V_BATT_SENSE_Pin|LINE_RIGHT_Pin|LINE_LEFT_Pin|MOTOR_SENSE_R_Pin
                          |MOTOR_SENSE_L_Pin|CONFIG_ADC_Pin|SHARP_C_ANALOG_Pin|SHARP_L_ANALOG_Pin);

    HAL_GPIO_DeInit(SHARP_R_ANALOG_GPIO_Port, SHARP_R_ANALOG_Pin);
...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef* htim_pwm)
{
  ...
  else if(htim_pwm->Instance==TIM4)
  {
    ...
    /* TIM4 DMA Init */
    /* GPDMA1_REQUEST_TIM4_UP Init */
    handle_GPDMA1_Channel0.Instance = GPDMA1_Channel0;
    handle_GPDMA1_Channel0.Init.Request = GPDMA1_REQUEST_TIM4_UP;
    ...
    __HAL_LINKDMA(htim_pwm, hdma[TIM_DMA_ID_UPDATE], handle_GPDMA1_Channel0);
