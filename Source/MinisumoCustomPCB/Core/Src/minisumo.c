...
void minisumo_loop()
{
  ...
  else  
  {
    ...
    switch(starstop)
    {
    case STARTSTOP_OK: status_rawLeds((Rgb){20,0,0}, (Rgb){20,0,0}); break;
    case STARTSTOP_RUN: isFighting = 1; break; // Start fighting
    case STARTSTOP_STOP: isFighting = 0; break;
    case STARTSTOP_DOHYOERR: status_rawLeds((Rgb){0,0,0}, (Rgb){0,20,0});break;
    case STARTSTOP_ADDRERR: status_rawLeds((Rgb){0,20,0}, (Rgb){0,0,0});break;
    default: break;
    }
  }
#if 0
